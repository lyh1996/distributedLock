...
import com.example.distributedLock.DistributedLock;
import com.example.distributedLock.annotation.CustomerLock;
import com.example.distributedLock.extension.ExtensionLoader;
...
public class DistributedLockAspect {
    ...
    //切入点：有这个注解的方法
    @Pointcut("@annotation(com.example.distributedLock.annotation.CustomerLock)")
